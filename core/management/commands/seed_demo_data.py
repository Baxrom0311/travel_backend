...
EVENTS = [
    {
        'title_uz': 'Xiva xalqaro ipak va ziravorlar festivali 2026',
        'title_en': 'Khiva International Silk and Spices Festival 2026',
        'title_ru': 'Международный фестиваль шёлка и специй в Хиве 2026',
...
NEWS = [
    {
        ...
        'slug': 'khiva-unesco-new-recognition-2026',
        'excerpt_uz': "Ichan-qal'a muzeyi 2026-yilda UNESCO tomonidan yana bir bor tan olindi. Yangi reytingda Xiva jahondagi eng yaxshi saqlangan qadimiy shaharlar ro'yxatiga kirdi.",
        'excerpt_en': 'Ichan-Kala museum has been recognized again by UNESCO in 2026. In the new ranking, Khiva has been included in the list of the best-preserved ancient cities in the world.',
        'excerpt_ru': 'Музей Ичан-Кала вновь признан ЮНЕСКО в 2026 году. В новом рейтинге Хива вошла в список лучше всего сохранившихся древних городов мира.',
    ...
    },
    {
        ...
        'slug': 'khorezm-new-airport-terminal-2026',
    ...
    },
    {
        ...
        'slug': 'ichan-kala-restoration-2026',
    ...
    },
    {
        ...
        'slug': 'new-premium-hotels-khiva-2026',
